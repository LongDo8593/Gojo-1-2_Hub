...
local Window = Fluent:CreateWindow({
    Title = "Gojo Satoru Hub",
    SubTitle = "- Free Super Ngon",
    TabWidth = 145,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Cày", Icon = "Gojo Satoru" }),
    Stats = Window:AddTab({ Title = "Vật phẩm", Icon = "Gojo Satoru" }),
    Info = Window:AddTab({ Title = "Thông Tin", Icon = "Gojo Satoru" }),
    Seaev = Window:AddTab({ Title = "Sự kiện biển", Icon = "Gojo Satoru" }),
    Player = Window:AddTab({ Title = "Player", Icon = "Gojo Satoru" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "Gojo Satoru" }),
    Fruit = Window:AddTab({ Title = "Blox Fruits", Icon = "Gojo Satoru" }),
    Raid = Window:AddTab({ Title = "Raids", Icon = "Gojo Satoru" }),
    Race = Window:AddTab({ Title = "Tộc V4", Icon = "Gojo Satoru" }),
    Shop = Window:AddTab({ Title = "Cửa Hàng", Icon = "Gojo Satoru" }),
    Misc = Window:AddTab({ Title = "Misc", Icon = "Gojo Satoru" }),
    Hop = Window:AddTab({ Title = "Máy Chủ", Icon = "Gojo Satoru" }),
    Setting = Window:AddTab({ Title = "Cài Đặt", Icon = "Gojo Satoru" }),
    Fluent = Window:AddTab({ Title = "Config", Icon = "Gojo Satoru" }),
}
...
if id == 2753915549 then First_Sea = true; elseif id == 4442272183 then Second_Sea = true; elseif id == 7449423635 then Third_Sea = true; else game.Players.LocalPlayer:Kick("Check script here : Telegram") end;
-- anti
function AntiBan()
...
print("made by Gojo Satoru")
    print("Gojo Satoru x hub")
    print("Script Make by LongDo Dz")
    print("boing boing")
    print("ty for using - have fun")
    print("sk (on discord : @longdo203)")
    print("wait ,.,")
    print("LCTSV - .,.")  
...
spawn(function()
    ...
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Cày Elite", Default = false })
...
if Second_Sea then
        local ToggleFactory = Tabs.Stats:AddToggle("ToggleFactory", {Title = "đánh nhà máy", Default = false })
...
--]]-- fluent
InterfaceManager:SetFolder("Gojo Satoru_HUB")
SaveManager:SetFolder("Gojo Satoru_HUB")
...
--[[
    ...
    delfolder("Gojo Satoru_HUB")
--]]
if Third_Sea then

    local ToggleSailBoat = Tabs.Seaev:AddToggle("ToggleSailBoat", {Title = "Tự mua thuyền và ngồi", Default = false })
...
local StatusBone = Tabs.Info:AddParagraph({
    ...
    local Togglehakiqs = Tabs.Player:AddToggle("Togglehakiqs", {Title = "bật haki quan sát", Default = false })
    ...
    local TogglePLH = Tabs.Player:AddToggle("TogglePLH", {Title = "đánh người chơi + nhận nhiệm vụ",  Default = false })
    ...
    local ToggleEnablePvp = Tabs.Player:AddToggle("ToggleEnablePvp", {Title = "Tự đoongh bật PVP", ,Default = false })
...
local ToggleCollectTP = Tabs.Fruit:AddToggle("ToggleCollectTP", {Title = "Dịch chuyển tới trái cây", Default = false })
...
if Second_Sea then
    local ToggleEvoRace = Tabs.Main:AddToggle("ToggleEvoRace", {Title = "Thức tỉnh tộc V2",Default = false })
...
--[[
local ToggleTweenFrozenDimension = Tabs.Seaev:AddToggle("ToggleTweenFrozenDimension", {Title = "bay đến đảo levi", Default = false })
...
local Togglelockmoon = Tabs.Seaev:AddToggle("Togglelockmoon", {Title = "Nhìn trăng + bật tộc", Default = false })
